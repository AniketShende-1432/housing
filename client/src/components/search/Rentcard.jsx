...
const Rentcard = ({ property, onViewNumber, handleSendsms, handlevisits }) => {
    ...
    return (
        <>
            <Link className="nav-link active small" aria-current="page" to="/rent-product" state={{ property }} onClick={() => { handlevisits(property._id, property.type) }}>
                <div className='cardsec d-flex flex-column flex-sm-row bg-white'>
                    ...
                    <div className='item-box2 p-3 pt-2 p-sm-4'>
                        <div className='card-head d-flex flex-column'>
                            ...
                            <label className='head2 d-none d-sm-block'>{property.bhk} in {property.societyName}</label>
                        </div>
                        ...
                        <div className='d-flex d-sm-none mb-2'>
                            <label className='fw-bold fs-6'>{property.bhk} ({property.features.bathrooms || ''} Baths)</label>
                            <label style={{ whiteSpace: "nowrap" }}>&nbsp; | {property.furnishedType}</label>
                        </div>
                        <div>
