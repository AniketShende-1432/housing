...
const PGcard = ({ property, onViewNumber, handleSendsms }) => {
    ...
    return (
        <>
            <Link className="nav-link active small" aria-current="page" to="/pg-product" state={{ property }}>
                <div className='cardsec d-flex bg-white'>
                    ...
                    <div className='item-box2 p-4'>
                        <div className='card-head d-flex flex-column'>
                            ...
                            <label className='head2'>PG in {property.societyName}</label>
                        </div>
