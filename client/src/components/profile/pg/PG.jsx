...
const PG = () => {
  ...
  const { property, mode } = location.state || {};
          ...
          <div className={errors.carea || errors.cunit ? 'mt-4' : 'mt-5'}>
            ...
            <div className='d-flex'>
              <button className='btn btn-light border' onClick={() => handlepgfurni("furni1")}
                style={clickedpgfurni.furni1 || pgData.furnishedType === 'Fully furnished' ? { border: "1px solid darkorange", backgroundColor: "#FFE5B4" } : {}} >Fully furnished</button>
              <button className='btn btn-light border ms-3' onClick={() => handlepgfurni("furni2")}
                style={clickedpgfurni.furni2 || pgData.furnishedType === 'Semi Furnished' ? { border: "1px solid darkorange", backgroundColor: "#FFE5B4" } : {}}>Semi Furnished</button>
              <button className='btn btn-light border ms-3' onClick={() => handlepgfurni("furni3")}
                style={clickedpgfurni.furni3 || pgData.furnishedType === 'Unfurnished' ? { border: "1px solid darkorange", backgroundColor: "#FFE5B4" } : {}} >Unfurnished</button>
            </div>
          ...
          <div className='mt-4'>
            ...
            <div className='d-flex'>
              <button className='btn btn-light border' onClick={() => handlepgfor("girl")}
                style={clickedpgfor.girl || pgData.availableFor === 'Girls' ? { border: "1px solid darkorange", backgroundColor: "#FFE5B4" } : {}} >Girls</button>
              <button className='btn btn-light border ms-3' onClick={() => handlepgfor("boy")}
                style={clickedpgfor.boy || pgData.availableFor === 'Boys' ? { border: "1px solid darkorange", backgroundColor: "#FFE5B4" } : {}}>Boys</button>
              <button className='btn btn-light border ms-3' onClick={() => handlepgfor("any")}
                style={clickedpgfor.any || pgData.availableFor === 'Any' ? { border: "1px solid darkorange", backgroundColor: "#FFE5B4" } : {}} >Any</button>
            </div>
